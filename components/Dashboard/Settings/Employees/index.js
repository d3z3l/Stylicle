      ...
      for (let i = 0; i < this.props.user_data.emploies.length; i++) {
        ...
        servicestimeslotes.push([i+1,
          ...
          <div class='mx-2 d-inline' >
            ...
            <FontAwesomeIcon
            onClick={()=>this.setState({show:true,employ_id:element._id})}
              style={{
                color: config.primaryColor,
                fontSize:'20px',
                cursor: "pointer"
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <form>
                    ...
                    <a onClick={this.hendalAddEmployees} href="#." class="btn button bg-blue-700 btn-info">
                      Add Employees
                    </a>
                  </form>
                </div>
                <div class="col-md-8">
                  ...
                  <div class="col-md-8">
                    ...
                    <MuiThemeProvider theme={this.getMuiTheme()}>
                      <MUIDataTable title={"Employee List"} data={this.state.servicestimeslotes} columns={columns} options={options} />
                    </MuiThemeProvider>
