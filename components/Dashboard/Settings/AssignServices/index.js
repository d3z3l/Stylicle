...
class Categories extends React.Component {
  ...
  update=()=>{
    ...
    AssignServicesHelper.Update(this.state.update_service_id,data).then((resp) => {
      this.setState({message:''})
      this.hendalGetAssignServices()
    });
  }
    ...
    return (
      <>
      {
          ...
          <SweetAlert
              ...
              title="Are you sure?"
              onConfirm={()=> this.hendalDeleteAssignServices(this.state.delete_service_id)}
                  ...
                  <form>
                    ...
                    <div class="mb-3">
                      ...
                      <select onChange={(text) => [
                          ...
                          <option selected value=''  disabled >Select Any Services</option>
                          {
                              ...
                              <>
                                <option disabled  >{item1.title}</option>
                                {
                                  item1.subcategories.map((item2,key2)=>(
                                    <>
                                      <option disabled >&nbsp;&nbsp;&nbsp;{item2.title}</option>
                                        {
                                          item2.services.map((item3,key3)=>(
                                            <option selected={this.state.services_id==item3._id}  value={item3._id} >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{item3.title}</option>
                                          ))
                                        }
                                    </>
                                  ))
                                  ...
                                  item1.subcategories.map((item2,key2)=>(
                                    <>
                                      <option disabled >&nbsp;&nbsp;&nbsp;{item2.title}</option>
                                        {
                                          item2.services.map((item3,key3)=>(
                                            <option   value={item3._id} >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{item3.title}</option>
                                          ))
                                        }
                                    </>
                                  ))
                ...
                <div class="col-md-8">
                  <div class="card p-3 uk-box-shadow-medium">
                    ...
                    <MuiThemeProvider theme={this.getMuiTheme()}>
                      <MUIDataTable title={"Services List"} data={this.state.assignservices} columns={columns} options={options} />
                    </MuiThemeProvider>
