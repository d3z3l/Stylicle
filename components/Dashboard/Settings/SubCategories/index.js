...
class Categories extends React.Component {
      ...
      for (let i = 0; i < resp.data.data.subCategories.length; i++) {
        ...
        subcategories.push([
          ...
          <>
            ...
            <FontAwesomeIcon
              onClick={() =>
                this.setState({ show: true, delete_subcat_id: element._id })
              }
              style={{
                color: config.primaryColor,
                fontSize: "20px",
  ...
  update = () => {
    ...
    SubCategoriesHelper.Update(this.state.update_subcat_id, data).then(
      (resp) => {
        this.setState({ message: "" });
        this.hendalGetSubCaterory();
      }
                    ...
                    <div class="mb-3">
                      ...
                      >
                        ...
                        {this.state.categories.map((val, index) => (
                          <option
                            selected={this.state.category_id == val._id}
                            value={val._id}
                          >
                            {val.title}
                          </option>
              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <form>
                    ...
                    <a
                      onClick={this.hendalCreateSubCaterory}
                      href="#."
                      class="btn button bg-blue-700 btn-info"
                    >
