    ...
    ServicesHelper.Get().then((resp) => {
      for (let i = 0; i < resp.data.data.services.length; i++) {
        ...
        services.push([
          ...
          element.title,
          element.subcategories?.title,
          <div class="switch-container">
            <label class="switch">
              <input
                onClick={() => {
                  this.hendalUpdateServices_featured(
                    element._id,
                    element.popular == "0",
                    "popular"
                  );
      ...
      <>
        {this.state.show ? (
          <SweetAlert
            ...
            title="Are you sure?"
            onConfirm={() =>
              this.hendalDeleteSubCategory(this.state.delete_subcat_id)
            }
                  ...
                  <form>
                    ...
                    <div class="mb-3">
                      ...
                      <select
                        onChange={(text) => [
                          this.setState({
                            subCategories_id: text.target.value,
                          }),
                        ]}
                        class="form-control"
                      >
                        <option
                          selected={this.state.subCategories_id == ""}
                          value=""
                          disabled
                        >
                          Select Any category
                        ...
                        {this.state.subCategories.map((val, index) => (
                          <option
                            selected={this.state.subCategories_id == val._id}
                            value={val._id}
                          >
                            {val.title}
                          </option>
              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <form>
                    ...
                    <a
                      onClick={this.hendalCreateServices}
                      href="#."
                      class="btn button bg-blue-700 btn-info"
                    >
                      Add new Service
