...
// import CategorAuthHelperiesHelper from "../../../../Helpers/AuthHelper";
...
class Categories extends React.Component {
  ...
  hendalStatus = async (id,condetion) => {
  ...
  hendalGetSubCaterory = () => {
    let subcategories=[]
    AuthHelper.getAllsellersAdmin().then((resp) => {
      for (let i = 0; i < resp.data.data.user.length; i++) {
        ...
        subcategories.push([i+1,
          ...
          <div class="switch-container">
            <label class="switch">
              <input
              onClick={()=>{this.hendalStatus(element._id,element.status=='1')}} 
          ...
          <>
          <Link  href={{pathname: '/admin/profile_seller' , query: { index: element._id!=null?element._id:null }}}  >
            <FontAwesomeIcon
              style={{
                ...
                <div class="col-md-12">
                  <div class="card p-3 uk-box-shadow-medium">
                    ...
                    <MuiThemeProvider theme={this.getMuiTheme()}>
                      <MUIDataTable title={" Sellers List"} data={this.state.subcategories} columns={columns} options={options} />
                    </MuiThemeProvider>
