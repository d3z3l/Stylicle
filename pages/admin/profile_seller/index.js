    ...
    return (
      <>
        ...
        <div class="container pro-container my-5">
                <div class="flex lg:flex-row flex-col items-center lg:py-8 lg:space-x-8">
                    ...
                    <div class="my-6 grid lg:grid-cols-2 grid-cols-2 gap-1.5  uk-link-reset" >
                        <div class="lg:w/8/12 flex-1 flex flex-col lg:items-start items-center"> 
                            ...
                            <p class="lg:text-left mb-2   dark:text-gray-100"> {this.state.Seller_data!=null?this.state.Seller_data.job_title:null}</p>
                            <p class="lg:text-left mb-2 mt-3  dark:text-gray-100"> {this.state.Seller_data!=null?this.state.Seller_data.disc:null}</p>
                        </div>
                        <div class="lg:w/8/12 flex-1 flex flex-col lg:items-start items-center"> 
                            <h2 class="font-semibold lg:text-2xl text-lg mb-2">Persoal Details</h2>
                ...
                <div class="my-6 grid lg:grid-cols-4 grid-cols-2 gap-1.5  uk-link-reset">
                    <div class="db-cbox dbb-red">
                        <div class="h-40 rounded-md relative overflow-hidden uk-transition-toggle" tabindex="0"> 
                            <div class="absolute  bottom-0 flex h-full items-center space-x-5 text-lg text-white  w-full">   
                                <h4 >Customers:<br/><span class="dss-value">83</span></h4>
                            </div>
                        </div>
                    </div>
                    <div class="db-cbox dbb-blue">
                        <div class="h-40 rounded-md relative overflow-hidden uk-transition-toggle" tabindex="0"> 
                            <div class="absolute  bottom-0 flex h-full items-center space-x-5 text-lg text-white  w-full">   
                                <h4>Orders:<br /><span class="dss-value">666</span> </h4>
                            </div>
                        </div>
                    </div>
                    <div class="db-cbox dbb-green">
                        <div class="h-40 rounded-md relative overflow-hidden uk-transition-toggle" tabindex="0"> 
                            <div class="absolute  bg-opacity-40 bottom-0 flex h-full items-center space-x-5 text-lg text-white  w-full">   
                                <h4>Deposits: <br /><span class="dss-value">$343</span></h4>
                            </div>
                        </div>
                    </div>
                    <div class="db-cbox dbb-gray">
                        <div class="h-40 rounded-md relative overflow-hidden uk-transition-toggle" tabindex="0"> 
                            <div class="absolute  bg-opacity-40 bottom-0 flex h-full items-center space-x-5 text-lg text-white  w-full">   
                                <h4>Withdraw:<br /><span class="dss-value">$5145</span></h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex lg:flex-row border-solid border-4 flex-col items-center mb-5 lg:space-x-8">
                    <div>
                        <div class="bg-gradient-to-tr from-yellow-600 to-pink-600 pl-2  m-0.5 mr-2  w-56 h-56 relative overflow-hidden uk-transition-toggle">  
                            <h2 class="font-semibold lg:text-2xl text-lg mb-2"> Business details</h2>
                            <p class="lg:text-left mb-2   dark:text-gray-100"> {this.state.Seller_data!=null?this.state.Seller_data.business:null}</p>
                            <p class="lg:text-left mb-2   dark:text-gray-100"> {this.state.Seller_data!=null?this.state.Seller_data.email:null}</p>
                            <p class="lg:text-left mb-2   dark:text-gray-100"> {this.state.Seller_data!=null?this.state.Seller_data.phone:null}</p>
                            <p class="lg:text-left mb-2   dark:text-gray-100"> {this.state.Seller_data!=null?this.state.Seller_data.address:null}</p>
                        </div>
                    </div>

                    <div class="lg:w/8/12 m-0 lg:h-64 flex-1 flex flex-col lg:items-start items-center"> 
                        {
                            this.state.Seller_data!=null?
                            <Map ondrag={()=>console.log(333)} data={this.state.Seller_data} />
