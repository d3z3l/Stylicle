...
class ViewSeller extends React.Component {
  ...
  getUserHendal = async () => {
    await AuthHelper.Get().then((resp) => {
      this.props._user_fname(
        resp.data.data.user.name.split(" ").slice(0, -1).join(" ")
      );
    ...
    return (
      <>
        ...
        <div class="maincontent">
          <div class="pakgwrepp">
            <div class="container">
              <h1 class="text-center my-1">Your business, your way sikvdf.</h1>
              <p class="text-center lh-lg my-3">
                Flexible pricing options so that you can access the solutions
                you need,
                <br /> when you need them. And when you don't? Turn them off,
                anytime.
              </p>
              <div class="row">
                    ...
                    <div class="card overflow-hidden rounded-0 position-relative pkgbox">
                      <div class="phgheader">
                        ...
                        {val.price == 0 ? (
                          ...
                          <a
                            onClick={() => this.hendalStatus(val._id)}
                          ...
                          <div class="row">
                            <div class="col-12">
                              <Link
                                href={{
                                  pathname:
                                    "/packages_seller/Checkout/" + val._id,
                                  query: { dueration: 2 },
                                }}
                              >
                                <a href="#." class="btn btn-white btn-block">
                                  USD {val.price_2 - 1 + 0.99} per order
                                </a>
                              </Link>
                            </div>
                            <div class="col-12">
