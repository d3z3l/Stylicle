      ...
      <>
        <Layout>
          <div class="container m-auto">
            ...
            <div
              class="lg:m-0 -mx-5 flex justify-between items-center py-2 relative space-x-3 dark-tabs"
            ...
            >
              <div class="flex overflow-x-scroll lg:overflow-hidden lg:pl-0 pl-5 space-x-3 lg:py-2">
                <a
                  href="#"
                  class="bg-white py-2 px-4 rounded inline-block font-bold shadow"
                >
                  {" "}
                  Hair Salon
                </a>
                ...
                <div class="bg-pink-400 h-full max-w-full overflow-hidden relative rounded-md uk-transition-toggle shadow-sm">
                  <a href="#story-modal" uk-toggle>
                    <img
                      ...
                      class="w-full h-full absolute object-cover inset-0 transform scale-125"
                    />
                  </a>
