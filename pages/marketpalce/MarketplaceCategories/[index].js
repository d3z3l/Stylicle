...
class ViewSeller extends React.Component {
  ...
  hendalSearch = (e) => {
    ...
    //  let data=this.state.Seller_data.assignservices.filter((assignservices) => !!assignservices.services.title.toLowerCase().match(regEx))
     let data=this.state.Seller_data.assignservices.filter((assignservices) => assignservices.services?!!assignservices.services.title.toLowerCase().match(regEx):false)
     console.log(22222);
              ...
              <div class="modal-body">
                ...
                <div class="bookingmodal_2">
                  ...
                  <div class="mobileservice pt-4 pb-4 border-0">
                    ...
                    <div>
                      <span  onClick={()=> {$('.bookingmodal_2').hide(),$('.bookingmodal_1').show()}} >
                        ...
                        <label  style={{cursor:'pointer'}} onClick={()=> {$('.bookingmodal_2').hide(),$('.bookingmodal_1').show()}} class="p-3" >add more</label>
                    </div>
                    {
                  ...
                  </div>
                  {
                    ...
                    :
                    <a onClick={this.hendalCheckout} href="#." class="btn btn-info btn-block btn-lg">
                      CONFIRM
                    </a>
                  }
                </div>
              ...
              <div class="row">
                <div class="col-md-8">
                          ...
                          <div class="ctgsldimg_full">
                            {
                              ...
                              <img src={config.image_url + this.state.Seller_data.banner_image} alt="" />
                              :null
                            }
                            {/* <p>
                  ...
                  <div class="babrerbox">
                    ...
                    <div class='row' >
                      <div class="col-10" ><h1 class="m-0" >{this.state.Seller_data!=null?this.state.Seller_data.name:null}</h1>
                      <p>{this.state.Seller_data!=null?this.state.Seller_data.email:null}</p></div>
                      <div class="col-2" >
                          <h1 class="bpf-btn">
                          {
                            this.state.login_status=='unauthorize'?
              ...
              // this.state.Assign_services.length!=0?(
                this.state.Assign_services.map((val,index)=>(
                  val.services!=undefined?
                    ...
                    <Services onBook={()=>this.setState({service_val:val._id,service_price:val.price,service_duration:val.duration,service_title:val.services.title,morning:'',afternon:'',evening:''})} title={val.services.title} disc={val.disc} duration={val.duration} price={val.price} />
                    </>
                  :null
                ))
              //  ):null
                  ...
                  <div class="venue_box">
                    ...
                    <div class="row">
                      {
                         this.state.Seller_data!=null && this.state.Seller_data.newsfeedsPosts.length!=0 ?(
                          <div class="col-md-6">
                            <img class="mb-3" src={config.image_url + this.state.Seller_data.newsfeedsPosts[0].media }  alt="" />
                          </div>
                         ):null
                      }
                        ...
                        <div class="row">
                          {
                            this.state.Seller_data!=null?(
                              this.state.Seller_data.newsfeedsPosts.map((val,index)=>(
                                index!=0?
                                  <div class="col-sm-6">
                                    <img style={{width:"100%",'max-height': '500px'}} class="mb-4" src={config.image_url + val.media } alt="" />
                                  </div>
                                :null
                              ))
                            ):null
                      ...
                      <Link  href={{pathname: '/dashboard/profile' , query: { index: this.state.Seller_data!=null?this.state.Seller_data._id:null }}} >
                        <a
                          href="#"
                      ...
                      this.state.Seller_data.reviews.map((val,index)=>(
                        <div class="commentrow">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="stars"> 
                                <FontAwesomeIcon style={{color: '#FBC02D',fontSize:'15px',cursor: "pointer"}} icon={faStar} />
                                <FontAwesomeIcon style={{color: '#FBC02D',fontSize:'15px',cursor: "pointer"}} icon={faStar} />
                                <FontAwesomeIcon style={{color: '#FBC02D',fontSize:'15px',cursor: "pointer"}} icon={faStar} />
                                <FontAwesomeIcon style={{color: '#FBC02D',fontSize:'15px',cursor: "pointer"}} icon={faStar} />
                                <FontAwesomeIcon style={{color: '#FBC02D',fontSize:'15px',cursor: "pointer"}} icon={faStar} />
                              ...
                              <p class="ctgnam">
                                ...
                                // console.log(val.orders.details),
                                  val.orders.details.map((val2,index2)=>(
                                    val2.assignservices.services.title +"  "
                                    ))
                                }
                                 <br/><span>by {this.state.Seller_data.name}</span></p>
                            </div>
                            <div class="col-md-6">
                              <p class="outhernam">{val.clint_name+" "}   
                                <FontAwesomeIcon style={{color: config.primaryColor,fontSize:'15px',cursor: "pointer"}} icon={faCheckCircle} />
                ...
                <div class="col-md-4">
                  <div class="barberright">
                    ...
                    <div class="p-3">
                      <h1>About Us</h1>
                      <p>
                      {this.state.Seller_data!=null?this.state.Seller_data.disc:null}
                      </p>
                    </div>
                    <div class="p-3">
                      ...
                      <div class="mobileservice">
                        <div class="row">
                          <div class="col-md-6">
                            <p class="bpp-text">
                              Phone:<strong> {this.state.Seller_data!=null?this.state.Seller_data.phone:null}</strong> 
                            </p>
                          </div>
                          <div class="col-md-6">
                            <div class="bookbtnrow">
                    ...
                    <div class="p-3">
                      ...
                      <ul>
                        ...
                        <li>
                        <LinkedinShareButton url={'https://www.npmjs.com/package/react-share'} className="Demo__some-network__share-button">
                        ...
                        <PinterestShareButton
                          url={'https://www.npmjs.com/package/react-share'}
                          media={'https://bestofreactjs.com/assets/images/logo_bestofreactjs.png'}
                          className="Demo__some-network__share-button"
                        >
